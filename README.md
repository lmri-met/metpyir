...
For a quick start guide and examples, please refer to the
[Documentation](https://lmri-met.github.io/metpyir/).

## Source Code

The source code is hosted on [GitHub](https://github.com/lmri-met/metpyir).

## Documentation

The documentation is available at [GitHub Pages](https://lmri-met.github.io/metpyir/).

## License

This project is licensed under the [BSD 3-Clause License](https://github.com/lmri-met/metpyir/blob/main/LICENSE).

## Support

For support, please email [the developer](mailto:xandra.campo@ciemat.es).

## Contributing

Contributions are always welcome!
If you find a bug or have a suggestion, please open an issue in the
[GitHub Issues tab](https://github.com/lmri-met/metpyir/issues).
